test_road_networks = [
    ...
    {
        "road_network_string": '{"graph": {"nodes": [{"id": 0}, {"id": 1}, {"id": 2}, {"id": 3}, {"id": 4}], "edges": [{"directed": false, "source": 0, "target": 3, "weight": 3, "orientation": "S"}, {"directed": false, "source": 1, "target": 4, "weight": 2, "orientation": "S"}, {"directed": false, "source": 2, "target": 3, "weight": 3, "orientation": "E"}]}}',
        "source": 0,
        "destination":3
    },
    {
        "road_network_string": '{"graph": {"nodes": [{"id": 0}, {"id": 1}, {"id": 2}, {"id": 3}], "edges": [{"directed": false, "source": 0, "target": 3, "weight": 3, "orientation": "S"}, {"directed": false, "source": 1, "target": 2, "weight": 2, "orientation": "S"}, {"directed": false, "source": 2, "target": 3, "weight": 3, "orientation": "E"}]}}',
        "source": 0,
        "destination":2
    }
]